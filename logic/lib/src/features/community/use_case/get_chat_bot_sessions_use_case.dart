...
@Injectable()
class GetChatBotSessionsUseCase extends BaseFutureUseCase<
    GetChatBotSessionsInput, GetChatBotSessionsOutput> {
  final AiChatBotRepository _aiChatBotRepository;

  const GetChatBotSessionsUseCase(this._aiChatBotRepository);

  @override
  Future<GetChatBotSessionsOutput> buildUseCase(
      GetChatBotSessionsInput input) async {
...
@freezed
class GetChatBotSessionsOutput extends BaseOutput
    with _$GetChatBotSessionsOutput {
