...
class _$IsLoggedInInputCopyWithImpl<$Res, $Val extends IsLoggedInInput>
  ...
  /// Create a copy of IsLoggedInInput
...
class _$IsLoggedInOutputImpl implements _IsLoggedInOutput {
  const _$IsLoggedInOutputImpl({this.isLoggedIn = false});
...
abstract class _IsLoggedInOutput implements IsLoggedInOutput {
